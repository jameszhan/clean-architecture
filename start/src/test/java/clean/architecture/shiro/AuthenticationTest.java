package clean.architecture.shiro;
...
public class AuthenticationTest {
    ...
    public void addUser() {
        ...
        simpleAccountRealm.addAccount("sa", "123456", "admin", "user");
        simpleAccountRealm.addAccount("editor", "123456", "admin", "user");
    }
    ...
    public void testAuthentication2() {
        ...
        UsernamePasswordToken token = new UsernamePasswordToken("sa", "123456");
        subject.login(token); // 登录
...
//        subject.checkRole("xxx"); // 报错
    ...
    public void testAuthentication3() {
        ...
        UsernamePasswordToken token = new UsernamePasswordToken("editor", "123456");
        subject.login(token); // 登录
